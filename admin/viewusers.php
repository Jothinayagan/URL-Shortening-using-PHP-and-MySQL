...
<tr><td>Name</td><td>password</td><td>Name</td><td>Last Login date</td></tr>			 
...
mysql_select_db("finalproj",$query);	
				 $query1=mysql_query("select * from users");
												   ...
												   {?>
											   <tr><td>	<?php echo $query2['username']; ?></td><td>	<?php echo $query2['password']; ?></td><td>	<?php echo $query2['name']; ?></td>
											   <td>	<?php echo $query2['lastlogin']; ?></td>
											   </tr>
