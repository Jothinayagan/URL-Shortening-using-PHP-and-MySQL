				...
				<div class="content-wrap">
					<div class="content">
						...
						<?php
							...
							$i = 1;
							$query1=mysql_query("select * from tbl_user_url where username='" . $username . "'");
							...
							{?>
								...
								<td><?php echo $query2['url'];?></td>
								<td><?php echo $query2['TimeModified']; ?> 
								<td><?php echo"<a href='delete.php?short=".$query2['gen']."'>Delete</a>";?></td></tr>
						<?php
						}?>	
						</table>
